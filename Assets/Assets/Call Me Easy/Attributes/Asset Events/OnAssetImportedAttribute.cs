...
{
  public static class OnAssetImported
  {
    private static Delegate m_OnAssetImported;
    ...
    {
      if( m_OnAssetImported != null )
      {
        m_OnAssetImported.Invoke(assetPath);
      }
    }
